MODULE INF_L
  ...
  ! Frame configuration
  PERS tooldata currentToolL:=[TRUE,[[0,0,130],[1,0,0,0]],[0.262,[7.8,11.9,50.7],[1,0,0,0],0.00022,0.00024,9E-05]];
  ...
  PERS tooldata currentToolR:=[TRUE,[[0,0,150],[1,0,0,0]],[0.262,[7.8,11.9,50.7],[1,0,0,0],0.00022,0.00024,9E-05]];
